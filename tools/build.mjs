...
for (const path of ['data/experience.json','data/publishing.json','models/kavyar-01.glb','images/site/favicon-32.png','images/site/brand-original.svg','images/palazzo/fresco-vault.webp','images/palazzo/paintings-atlas.webp']) {
